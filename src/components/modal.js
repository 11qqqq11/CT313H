  ...
  return ReactDom.createPortal(
    ...
    <>
      ...
      <div className='modal'>
        ...
        <img alt='cover_1' src={"https://yts.torrentbay.to/assets/images/movies/" + item.slug.toLowerCase().split("-").join("_") + "/medium-screenshot1.jpg"} />

        <img alt='cover_2' src={"https://yts.torrentbay.to/assets/images/movies/" + item.slug.toLowerCase().split("-").join("_") + "/medium-screenshot2.jpg"} />

        <img alt='cover_3' src={"https://yts.torrentbay.to/assets/images/movies/" + item.slug.toLowerCase().split("-").join("_") + "/medium-screenshot3.jpg"} />
